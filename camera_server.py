...
if __name__ == '__main__':
    ...
    parser.add_argument('--certificate', type=str, help='Optionally supply a path to your own PEM format TLS certificate (a self-sign is auto-generated by default)')
